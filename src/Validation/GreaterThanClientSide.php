...
class GreaterThanClientSide extends GreaterThan
{
    ...
    public static function cloneFromModelValidation(GreaterThan $validation)
    {
        return new self($validation->name, $validation->greaterThan, $validation->equalTo);
    }
}