...
class LessThanClientSide extends LessThan
{
    ...
    public static function cloneFromModelValidation(LessThan $validation)
    {
        return new self($validation->name, $validation->lessThan, $validation->equalTo);
    }
}