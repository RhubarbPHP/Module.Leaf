var bridge = function (presenterPath) {
    window.rhubarb.viewBridgeClasses.MultipleHtmlFileUploadViewBridge.apply(this, arguments);
};

bridge.prototype = new window.rhubarb.viewBridgeClasses.MultipleHtmlFileUploadViewBridge();
...
bridge.prototype.filesSelected = function (files) {
    ...
    window.rhubarb.viewBridgeClasses.MultipleHtmlFileUploadViewBridge.prototype.filesSelected.apply(this, arguments);
};
...
bridge.prototype.onRegistered = function () {
    window.rhubarb.viewBridgeClasses.MultipleHtmlFileUploadViewBridge.prototype.onRegistered.apply(this, arguments);
...
window.rhubarb.viewBridgeClasses.DragAndDropFileUploadViewBridge = bridge;